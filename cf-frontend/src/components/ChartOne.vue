            ...
            chartInstance = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: chartType.value === 'line' ? [20000, 25000, 28000, 32000, 35000, 38000, 40000, 42000, 45000, 48000, 50000, 52000, 54000, 56000, 58000, 59000, 58000, 55000] :
                            [2000, 3000, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500],
